...
void LogTable::Put(const std::string& key, const std::span<const std::vector<uint8_t>> value) const { Put2D<uint8_t>(key, value); }
void LogTable::Put(const std::string& key, const std::span<const std::vector<int>> value) const { Put2D<int>(key, value); }
void LogTable::Put(const std::string& key, const std::span<const std::vector<int64_t>> value) const { Put2D<int64_t>(key, value); }
void LogTable::Put(const std::string& key, const std::span<const std::vector<float>> value) const { Put2D<float>(key, value); }
void LogTable::Put(const std::string& key, const std::span<const std::vector<double>> value) const { Put2D<double>(key, value); }
void LogTable::Put(const std::string& key, const std::span<const std::vector<std::string>> value) const { Put2D<std::string>(key, value); }
...
std::vector<std::vector<uint8_t>> LogTable::Get(const std::string_view key, const std::span<const std::vector<uint8_t>> defaultValue) const { return Get2D<uint8_t>(key, defaultValue); }
std::vector<std::vector<int>> LogTable::Get(const std::string_view key, const std::span<const std::vector<int>> defaultValue) const { return Get2D<int>(key, defaultValue); }
std::vector<std::vector<int64_t>> LogTable::Get(const std::string_view key, const std::span<const std::vector<int64_t>> defaultValue) const { return Get2D<int64_t>(key, defaultValue); }
std::vector<std::vector<float>> LogTable::Get(const std::string_view key, const std::span<const std::vector<float>> defaultValue) const { return Get2D<float>(key, defaultValue); }
std::vector<std::vector<double>> LogTable::Get(const std::string_view key, const std::span<const std::vector<double>> defaultValue) const { return Get2D<double>(key, defaultValue); }
std::vector<std::vector<std::string>> LogTable::Get(const std::string_view key, const std::span<const std::vector<std::string>> defaultValue) const { return Get2D<std::string>(key, defaultValue); }
