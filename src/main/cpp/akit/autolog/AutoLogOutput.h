...
#define SET_LOG_PREFIX(expr) \
    std::optional<std::string> logPrefixOverride_{std::string(expr)}

#define AKIT_AUTOLOG_DECLARE_PREFIX_HELPER(name) \
    static constexpr std::string_view AutoLogClassName_##name() { \
        return ::akit::detail::ExtractEnclosingClassName(AKIT_FUNCTION_SIGNATURE, \
                                                         "::AutoLogClassName_" #name); \
    }
...
#define AKIT_AUTOLOG_OUTPUT_4(type, name, key_arg, unit_type) \
    AKIT_AUTOLOG_OUTPUT_5(type, name, key_arg, unit_type, ::akit::DefaultSerializable)

#define AKIT_AUTOLOG_OUTPUT_3(type, name, key_arg) \
    AKIT_AUTOLOG_OUTPUT_5(type, name, key_arg, ::akit::NoUnitTag, ::akit::DefaultSerializable)

#define AKIT_AUTOLOG_OUTPUT_2(type, name) \
    AKIT_AUTOLOG_OUTPUT_5(type, name, ::akit::DefaultKey, ::akit::NoUnitTag, ::akit::DefaultSerializable)

#define AKIT_AUTOLOG_OUTPUT_SELECT(_1, _2, _3, _4, _5, NAME, ...) NAME
#define AUTOLOG_OUTPUT(...) \
    AKIT_AUTOLOG_OUTPUT_SELECT(__VA_ARGS__, AKIT_AUTOLOG_OUTPUT_5, AKIT_AUTOLOG_OUTPUT_4, \
                               AKIT_AUTOLOG_OUTPUT_3, AKIT_AUTOLOG_OUTPUT_2)(__VA_ARGS__)
...
#define AKIT_AUTOLOG_OUTPUT_SUPPLIER_3(name, expr, key_arg) \
    AKIT_AUTOLOG_OUTPUT_SUPPLIER_5(name, expr, key_arg, ::akit::NoUnitTag, ::akit::DefaultSerializable)
...
#define AUTOLOG_OUTPUT_SUPPLIER(...) \
    AKIT_AUTOLOG_OUTPUT_SUPPLIER_SELECT(__VA_ARGS__, AKIT_AUTOLOG_OUTPUT_SUPPLIER_5, \
                                        AKIT_AUTOLOG_OUTPUT_SUPPLIER_4, AKIT_AUTOLOG_OUTPUT_SUPPLIER_3, \
